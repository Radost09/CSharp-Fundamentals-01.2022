    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while((command = Console.ReadLine()) != "end of assignment")
            {
                ...
                if(isAllreadyMemberOfTeam(teams, memberName))
                {
            ...
            PrindValidTeams(teamsWithMembers);
            PrintInvalidTeams(teamsToDisband);
            
        }
        static bool isAllreadyMemberOfTeam(List<Team> teams, string memberName)
        {
        ...
        static void PrindValidTeams(List<Team> validTeams)
        {
